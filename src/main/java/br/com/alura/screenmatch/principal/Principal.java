...
public class Principal {
    ...
    private final String API_KEY = "&apikey=94578081";
    ...
    public void exibeMenu() {
        ...
        for (int i = 1; i <= dados.totalTemporadas(); i++) {
            ...
            DadosTemporada dadosTemporada = conversor.oberterDados(json, DadosTemporada.class);
...
//        List<String> nomes = Arrays.asList("João", "Emanuele", "Jéssica", "Nadyne", "Bebéia", "Claúdia");
//        nomes.stream()
//                .sorted()
...
//                .forEach(System.out::println);
        ...
        System.out.println("\nLidar com os dados do Episódios");
...
//                                ));
        ...
        System.out.println("Melhor episódio: " + statistics.getMin());
